...
def main():
    ...
    parser.add_argument('--edges_csv', help='Path to CSV file of edges, from osmnet. Must have from_lat, from_lng, to_lat, to_lng')
    ...
    if args.latlng:
        ...
        for idx, row in edges.iterrows():
            ...
            grades.append(round(100.0*(to_elevation[-1] - from_elevation[-1]) / row['distance'], 2))
